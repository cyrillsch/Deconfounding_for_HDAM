...
<i>C. Scheidegger, Z. Guo, and P. Bühlmann. Spectral deconfounding for high-dimensional sparseadditive models. ACM/IMS Journal of Data Science, 2(1), 2025.</i>.
...
If you want to use the method, please use the function `SDAM` in the R package [SDModels](https://github.com/markusul/SDModels/).
